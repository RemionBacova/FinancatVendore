<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sipas373vit.aspx.cs" Inherits="FinancaVendore.data.sipas373vit" %>
...
<section id="services" class="main-content">
                ...
                <div class="container">
                    ...
                    <div class="col-lg-6 selectdata">
                          <h4>Regjionet</h4>
                          <div class="regjionet">
                              <asp:DropDownList ID="dropRegjionet" runat="server" AutoPostBack="True" OnTextChanged="dropRegjionet_TextChanged"></asp:DropDownList>
                        ...
                        <asp:Button ID="Button1" runat="server" Text="Gjenero Grafikun 1" class="btn btn-primary btn-lg btn-send-msg" OnClick="Button1_Click" />
                             <asp:Button ID="Button2" runat="server" Text="Gjenero Grafikun 2" class="btn btn-primary btn-lg btn-send-msg" OnClick="Button2_Click" />
                               <asp:Button ID="Button3" runat="server" Text="Gjenero Grafikun 2" class="btn btn-primary btn-lg btn-send-msg" OnClick="Button3_Click" />
                            </div>
