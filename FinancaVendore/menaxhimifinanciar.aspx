<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="menaxhimifinanciar.aspx.cs" Inherits="FinancaVendore.menaxhimifinanciaraspx" %>
            ...
            <div class="container">
                <div class="col-sm-12">
                    ...
                    <div class="col-sm-8">
                        ...
                        <h4 style="display: inline-block; padding-right: 30px;">Indikatoret</h4>
            ...
            <div class="container">
                ...
                <div class="col-lg-6 selectdata">
                    ...
                    <div class="njesite-dropdown">
                              <asp:DropDownList ID="dropGrupNjesite" runat="server" AutoPostBack="True"></asp:DropDownList>
