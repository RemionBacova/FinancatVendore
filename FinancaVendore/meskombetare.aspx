<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="meskombetare.aspx.cs" Inherits="FinancaVendore.meskombetare" %>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12 title">
                        <h2>Krahaso me Mesataren Kombëtare</h2>
...
<div class="indikatoret">            
    <asp:DropDownList ID="dropIndikatori" runat="server" AutoPostBack="True"></asp:DropDownList>
        ...
        <section id="services" class="main-content">
            ...
            <div class="container">
                <div class="col-lg-10"> <h4 class="auto-style1">Sipas:</h4>
